                    ...
                    <div className="grid grid-cols-2 gap-x-12 gap-y-6">
                        ...
                        <div className="space-y-2">
                            ...
                            {jobs.length > 0 && (
                                <Select onValueChange={(value) => handleSelectChange("jobId", value)}
                                        value={formData.jobId ? String(formData.jobId) : "default"}>
                        ...
                        <div className="space-y-2">
                            ...
                            <Select onValueChange={(value) => handleSelectChange("candidateId", value)}
                                    value={formData.candidateId ? String(formData.candidateId) : undefined}>
                                <SelectTrigger className="bg-white">
                        ...
                        <div className="space-y-2">
                            ...
                            <Select onValueChange={(value) => handleSelectChange("userId", value)}
                                    value={formData.userId ? String(formData.userId) : undefined}>
                                <SelectTrigger className="bg-white">
