        ...
        const loadData = async () => {
            if (id) {
                ...
                if (jobData) {
                    ...
                    setStartDate(jobData.startDate ? new Date(jobData.startDate) : new Date());
                    setMultipleSkills(jobData.requiredSkills || []);
                    setMultipleBenefits(jobData.benefits || []);
                    setMultipleLevel(jobData.level || []);
                    setEndDate(jobData.endDate ? new Date(jobData.endDate) : new Date());
                }
            }
        };
            ...
            <form className="space-y-8 bg-[#f8f9fc] p-6 rounded-lg">
                    ...
                    <div className="grid grid-cols-2 gap-x-12 gap-y-6">
                        ...
                        <div className="space-y-2">
                            ...
                            <Input id="title" placeholder="Type a working address..." className="bg-white"
                                   name="workingAddress"
                                   value={formData.workingAddress} onChange={handleInputChange} disabled/>
                        </div>
                        ...
                        <div className="space-y-2">
                            ...
                            <Input id="status" placeholder="Type a status..." className="bg-white"
                                   name="status"
                                   value={formData.status} onChange={handleInputChange} disabled/>
                        </div>
                ...
                <div className="flex justify-center gap-4 pt-4">
                    <Button type="button" className="w-24"
                            onClick={() => router.push(`/job/edit?id=${formData?.jobId}`)}
                    >Edit</Button>
                    <Button
                        type="button"
                        className="w-24"
